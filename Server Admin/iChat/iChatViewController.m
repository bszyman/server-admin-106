...
#import "iChatOverviewViewController.h"
#import "iChatLogsViewController.h"
#import "iChatSettingsViewController.h"
                         ...
                         bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        [self.tabs setNotificationName:@"iChatNavUpdate"];
        ...
        NSViewController *vc = [[iChatOverviewViewController alloc] initWithNibName:@"iChatOverviewViewController"
...
- (void)changeModuleSubnavigation:(NSNotification *)n
{
    ...
    if ([tabTitle isEqualToString:@"Logs"]) {
        if ([self.panels objectForKey:@"logs"]) {
            ...
            NSViewController *vc = [[iChatLogsViewController alloc] initWithNibName:@"iChatLogsViewController"
                                                                                       bundle:[NSBundle mainBundle]];
        ...
        if ([self.panels objectForKey:@"settings"]) {
            ...
            NSViewController *vc = [[iChatSettingsViewController alloc] initWithNibName:@"iChatSettingsViewController"
                                                                                       bundle:[NSBundle mainBundle]];
