...
#import "WebOverviewViewController.h"
#import "WebLogsViewController.h"
#import "WebGraphsViewController.h"
#import "WebSitesViewController.h"
#import "WebSettingsViewController.h"
                         ...
                         bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        [self.tabs setNotificationName:@"WebNavUpdate"];
        ...
        [self.tabs addTabWithImageNamed:@"NSBonjour" title:@"Sites"];
        ...
        NSViewController *vc = [[WebOverviewViewController alloc] initWithNibName:@"WebOverviewViewController"
...
- (void)changeModuleSubnavigation:(NSNotification *)n
{
    ...
    if ([tabTitle isEqualToString:@"Logs"]) {
        if ([self.panels objectForKey:@"logs"]) {
            ...
            NSViewController *vc = [[WebLogsViewController alloc] initWithNibName:@"WebLogsViewController"
                                                                                       bundle:[NSBundle mainBundle]];
        ...
        if ([self.panels objectForKey:@"graphs"]) {
            ...
            NSViewController *vc = [[WebGraphsViewController alloc] initWithNibName:@"WebGraphsViewController"
                                                                                       bundle:[NSBundle mainBundle]];
            [self.panels setObject:vc forKey:@"graphs"];
            [self.panelView addSubview:vc.view];
        }
    } else if ([tabTitle isEqualToString:@"Sites"]) {
        if ([self.panels objectForKey:@"sites"]) {
            NSViewController *vc = [self.panels objectForKey:@"sites"];
            [self.panelView addSubview:vc.view];
        } else {
            NSViewController *vc = [[WebSitesViewController alloc] initWithNibName:@"WebSitesViewController"
                                                                                       bundle:[NSBundle mainBundle]];
            [self.panels setObject:vc forKey:@"sites"];
            [self.panelView addSubview:vc.view];
        }
        ...
        if ([self.panels objectForKey:@"settings"]) {
            ...
            NSViewController *vc = [[WebSettingsViewController alloc] initWithNibName:@"WebSettingsViewController"
                                                                                       bundle:[NSBundle mainBundle]];
