...
#import "MySqlOverviewViewController.h"
#import "MySqlLogsViewController.h"
#import "MySqlSettingsViewController.h"
                         ...
                         bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        [self.tabs setNotificationName:@"MySqlNavUpdate"];
        ...
        NSViewController *vc = [[MySqlOverviewViewController alloc] initWithNibName:@"MySqlOverviewViewController"
...
- (void)changeModuleSubnavigation:(NSNotification *)n
{
    ...
    if ([tabTitle isEqualToString:@"Logs"]) {
        if ([self.panels objectForKey:@"logs"]) {
            ...
            NSViewController *vc = [[MySqlLogsViewController alloc] initWithNibName:@"MySqlLogsViewController"
                                                                                       bundle:[NSBundle mainBundle]];
        ...
        if ([self.panels objectForKey:@"settings"]) {
            ...
            NSViewController *vc = [[MySqlSettingsViewController alloc] initWithNibName:@"MySqlSettingsViewController"
                                                                                       bundle:[NSBundle mainBundle]];
